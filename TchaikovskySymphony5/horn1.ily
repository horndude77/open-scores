...
hornOneMvtI = \relative c'
{
  ...
  %stringendo
  b,4\p\justCrescMolto b8~ b cis4 |
  cis4 cis8~ cis cis4 |
  fis4 fis8 e e4 |
  f4 f8 e e4 |
...
hornOneMvtII = \relative c'
{
  ...
  %C
  b\mf\crescPocoAPoco \fivex b \sixx c |
  \twelvex cis |
  ...
  \scaleDurations #'(3 . 2)
  {
    ...
    a a \fourx fis a a gis\cresc gis \sixx gis |
    ...
    cis\cresc cis \sixx cis \fourx fis \fourx f |
    \eightx f \eightx fis |
