koppTwentyNine = \relative c''
{
  ...
  e-. g'[\p f e] d-. f,,[\f g a] |
  b-. d'[\p b g] c4 r |
  r2 r8 e[_\markup{\dynamic p dolce} d cis] |
  d d,[ fis g] a e'[ d cis] |
  d d,[ g a] b d[ c b] |
  a c,[ d e] fis c'[ b a] |
  g g[ d b] g4 r |
  ...
  \repeat volta 2
  {
    \times 2/3 {a8(_\markup{\italic "cresc."} b) cis} |
    \times 2/3 {d( a) d-.} \times 2/3 {e( a,) e'-.} \times 2/3 {f( a,) f'-.} \times 2/3 {e( a,) e'-.} |
